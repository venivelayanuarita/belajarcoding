      ...
      <div class="container-fluid">
        <!-- Small boxes (Stat box) -->
          ...
          <div class="card">
            ...
            <div class="card-body">
                <div class="py-4">
                   <a href="<?php echo site_url('laundry/tambah');?>" class="btn btn-primary"><i class="fa fa-plus-circle"></i> Tambah Data</a>
               </div>
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>
                    <a class="btn btn-warning" href="<?php echo site_url('laundry/edit/'.$value->id_paket); ?>">
                    <i class="fa fa-edit"></i>Edit</a>
                    <a class="btn btn-danger" href=" <?php echo site_url('laundry/hapus/'.$value->id_paket); ?>">
